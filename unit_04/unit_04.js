...
function f4() {
    ...
    let mcb4 = document.querySelector('.i-4');
    console.log(mcb4.checked);
    if (mcb4.checked) {
        console.log('true');
...
function f5() {
    console.log(document.querySelector('.i-5').value);
    let mcb5 = document.querySelector('.i-5');
    console.log(mcb5.checked);
    if (mcb5.checked) {
        console.log(document.querySelector('.i-5').value);
...
function f9() {
    ...
    let mcb9 = document.querySelector('.r-9');
    console.log(mcb9.checked);
    if (mcb9.checked) {
        console.log(document.querySelector('.r-9').value);
        out9.innerHTML = document.querySelector('.r-9').value;
    }
    else {
        console.log('false');
...
function f11() {
    // console.log(document.querySelector('.i-111'));
    // let clri111 = document.querySelector('.i-111').value;
    // console.log(document.querySelector('.i-112'));
    // let clri112 = document.querySelector('.i-112').value;

    // document.querySelector('.i-112').style.textareaColor = clri111; 
    // document.querySelector('.i-112').style.backgroundColor = clri111;
...
function f14() {
    console.log(document.querySelector('.t-14').value);
...
function f15() {
    console.log(document.querySelector('.i-15').value);
    ...
    // document.querySelector('.out-15').innerHTML , document.querySelector('.t-15').innerHTML = i15;
}
